...
//                WHERE m.m_id = url.u_movieid AND m.m_pid = p.p_id  AND (url.android_vedio_url IS NUaL OR url.android_vedio_url ='') and m.m_id=13079";
//
...
//    	global $db;
    ...
    function parseVideoTypes($p_ids){
    	...
    	$sql = "SELECT m.m_pid as p_id, m.m_urltest as m_urltest, m.m_id as m_id 
                ...
                ;
//               AND (url.android_vedio_url IS NUaL OR url.android_vedio_url ='') ";
