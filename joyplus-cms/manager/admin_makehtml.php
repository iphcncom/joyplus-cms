...
function checkViewType($cs)
{
    ...
    if ($viewtype != 2 ){ alert ( $des.":浏览为静态模式时才可以生成相关页面,请切换后重试"); }
}
...
<tr>
<td>
&nbsp;<input type="button" id="btnvod1" value="生成选择栏目" class="input" />
&nbsp;<input type="button" id="btnvod2" value="生成全部栏目" class="input" /> <br>
&nbsp;<input type="button" id="btnvod3" value="生成选择内容" class="input" />
&nbsp;<input type="button" id="btnvod4" value="生成全部内容" class="input" /> <br>
&nbsp;<input type="button" id="btnvod5" value="一键生成当天" class="input" />
</td>
<td>
&nbsp;<input type="button" id="btnvod6" value="生成选择专题" class="input" />
&nbsp;<input type="button" id="btnvod7" value="生成全部专题" class="input" /> <br>
&nbsp;<input type="button" id="btnvod8" value="生成专题首页" class="input" /> <br>
&nbsp;
</td>
<td>
  &nbsp;<input type="button" id="btnvod9" value="按数字生成内容" class="input" />
<br><br>
  &nbsp;
</td>
</tr>
...
<tr>
<td>
&nbsp;<input type="button" id="btnart1" value="生成选择栏目" class="input" />
&nbsp;<input type="button" id="btnart2" value="生成全部栏目" class="input" /> <br>
&nbsp;<input type="button" id="btnart3" value="生成选择内容" class="input" />
&nbsp;<input type="button" id="btnart4" value="生成全部内容" class="input" /> <br>
&nbsp;<input type="button" id="btnart5" value="一键生成当天" class="input" />
</td>
<td>
&nbsp;<input type="button" id="btnart6" value="生成选择专题" class="input" />
&nbsp;<input type="button" id="btnart7" value="生成全部专题" class="input" /> <br>
&nbsp;<input type="button" id="btnart8" value="生成专题首页" class="input" /> <br>
&nbsp;
</td>
<td>
&nbsp;<input type="button" id="btnart9" value="按数字生成内容" class="input" /> 
 <br><br>
&nbsp;
</td>
</tr>
...
<input type="submit" name="Submit" value="生成自定义页面" class="input">
<input type="submit" name="Submit" value="生成全部自定义页" class="input" onClick="javascript:document.diypageform.action='admin_makehtml.php?action=diypageall';diypageform.submit();">      </td>
</tr>
</form> 
...
{
	global $flag,$stime,$psize,$makeinterval,$cache,$mac,$db,$template;
...
function makeviewbytype($typeid,$ids,$allnum)
{
	...
	if ($macpage == $pcount || $nums<100){
		if (isN($action2) && $num>$allnum){
			...
			echo "页面生成时间: ".(execTime()-$stime)."秒 &nbsp;<font color='red'>恭喜".$typename."搞定</font><br>暂停".$makeinterval."秒后继续生成<script language=\"javascript\">setTimeout(\"makeNextPage();\",".$makeinterval."000);function makeNextPage(){location.href='?action=".$action."&mtype=".$ids."&flag=".$flag."&num=".($num + 1)."&page=1&action2=".$action2."';}</script>";return;
		}
}
...
function maketypeday($sql)
{
	...
	echo "<br>准备生成当天数据的分类，请稍候...<script language=\"javascript\">setTimeout(\"makeNextPage();\",".$makeinterval."000);function makeNextPage(){location.href='?action=type&flag=".$flag."&mtype=".$ids."&action2=day';}</script>";
}
...
function maketopic()
{
	...
	makeTopicById ($topic);
	alertUrl ("生成专题列表完成","admin_makehtml.php");
}
