...
CREATE TABLE IF NOT EXISTS `mac_cj_vod_projects` (
  ...
  PRIMARY KEY (`p_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1854 ;
...
(177, '百度电影', 'GB2312', 'baidu', 1, '', 'http://video.baidu.com/commonapi/movie2level/?callback=jQuery19109205652033106855_1368604219634&filter=false&type=&area=&actor=&start=&complete=&order=hot&pn={ID}&rating=&_=1368604219636', '', '13', '13', 8191, 0, 1, 0, 0, 0, '<div class="bd">', '<div class="ft">', 0, 1, '2013-07-10 15:28:55', '<dt class="v-title"><a href="', '"', 0, '主演：</span>', '</li>', 0, '<div class="title-wrapper clearfix">', '<span', 0, '<img src="', '"', '<span class="year">', '</span>', '地区：</span>', '</li>', '<ul class="aside-highlight">', '</ul>', '简介：</span>', '</span>', 0, '', '', '时长：</span>', '分钟</li>', 0, '"site_url":', '"', 0, '', '', '0', 0, 0, '', '', 0, 0, '', '', '语言：</span>', '</li>', '', '', '导演：</span>', '</li>', 0, '', '', 'size="""""""""""""""""""""""""""""""""""', 0, '""', '""', '', '', '', '', '', 0),
(179, '百度综艺', 'GB2312', 'baidu', 1, '', 'http://video.baidu.com/commonapi/tvshow2level/?callback=jQuery19101723327927027405_1369964574718&filter=false&type=&area=&actor=&start=&complete=&order=hot&pn={ID}&rating=&prop=&_=1369964574721', '', '1', '1', 8191, 0, 1, 0, 0, 0, '<div class="bd">', '<div class="ft">', 0, 3, '2013-07-10 15:29:42', '<dt class="v-title"><a href="', '"', 0, '', '', 0, '"trunk":"', '"', 0, '<img src="', '"', '"years":["', '"]', '"area":["', '"]', '', '', '"brief":"', '"', 0, '', '', '"url_prefix":"', '"', 0, '', '', 0, '', '', '0', 0, 0, '', '', 0, 0, '"max_episode":"', '"', '<?echo $p_languagestart?>', '<?echo $p_languageend?>', '"update_freq":"', '"', '', '', 0, '', '', 'size=""""""""""""""', 0, '""', '""', '', '', '', '', '', 0),
(180, '百度动漫', 'GB2312', 'baidu', 1, '', 'http://video.baidu.com/commonapi/comic2level/?callback=jQuery191025315059880813306_1369966105776&filter=true&type=&area=&actor=&start=&complete=&order=hot&pn={ID}&rating=&prop=&_=1369966105778', '', '1', '76', 8191, 0, 1, 0, 0, 0, '<div class="bd">', '<div class="ft">', 0, 131, '2013-07-10 14:32:46', '<dt class="v-title"><a href="', '"', 0, '"leader": ["', '"]', 0, '"trunk": "', '"', 0, '<img src="', '"', '"al_date": "', '"', '"area": ["', '"', '', '', '"brief": "', '"', 1, '"sites":', ', "max_episode":', '"url_prefix": "', '"', 0, '', '', 0, '', '', '0', 0, 0, '"episode": "', '"', 0, 1, '"max_episode": "', '"', '<?echo $p_languagestart?>', '<?echo $p_languageend?>', '', '', '"director": ["', '"', 0, '', '', 'size=""""""""""""""""""', 0, '""', '""', '', '', '', '', '', 0),
(1853, '百度电视剧', 'GB2312', 'baidu', 1, '', 'http://video.baidu.com/commonapi/tvplay2level/?callback=jQuery19105037843275615373_1368593570491&filter=true&type=&area=&actor=&start=&complete=&order=pubtime&pn={ID}&rating=', '', '5', '5', 8191, 0, 1, 0, 0, 0, '<div class="bd">', '<div class="ft">', 0, 2, '2013-07-10 13:04:25', '<dt class="v-title"><a href="', '"', 0, '主演：</span>', '</li>', 0, '<div class="title-wrapper clearfix">', '<span class="update-info">', 0, '<img src="', '"', '<span class="year">', '</span>', '地区：</span>', '</li>', '<ul class="aside-highlight">', '</ul>', '简介：</span>', '</span>', 1, '', '', '时长：</span>', '分钟</li>', 0, '', '', 0, '', '', '0', 0, 0, 'episode: ''', '''', 0, 0, '更新至', '"', '语言：</span>', '</li>', '共', '集', '导演：</span>', '</li>', 0, '', '', ' size=', 0, '""', '""', '', '', '', '', '', 0);
