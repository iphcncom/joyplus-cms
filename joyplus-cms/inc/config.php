...
define("app_dbname","joyplus");      					  //SQL数据库名称
define("app_dbuser","root");      //SQL数据库用户名
define("app_dbpass","");      					  //SQL数据库密码
...
define("app_safecode","admin");      //后台登录安全码
...
define("app_vodmakeinterval",5);        //生成视频静态页面间隔
...
define("app_artmakeinterval",5);        //生成文章静态页面间隔
...
define("app_waterfont","joyplus.tv");          //水印文字
