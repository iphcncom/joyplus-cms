...
class AppDataBase
{
	...
	function AppDataBase($dbhost, $dbuser, $dbpw, $dbname = '', $charset = 'utf8')
	{
		if(!($this->sql_id = mysql_connect($dbhost, $dbuser, $dbpw ,true))){
	...
	function Add($tableName,$arrFieldName ,$arrValue)
	{
		...
		if (chkArray($arrFieldName,$arrValue)){
			...
			writetofile("log.log"," INSERT INTO " . $tableName." (".$sqlcol.") VALUES(".$sqlval.")");
			$res = $this->query(" INSERT INTO " . $tableName." (".$sqlcol.") VALUES(".$sqlval.")" );
	...
	function Update($tableName,$arrFieldName , $arrValue ,$KeyStr)
	{
		...
		if (chkArray($arrFieldName,$arrValue)){
			...
			writetofile("x.txt"," UPDATE " . $tableName." SET ".$sqlval." WHERE ".$KeyStr." ;" );
			$res = $this->query(" UPDATE " . $tableName." SET ".$sqlval." WHERE ".$KeyStr."" );
//			$res=true;
		}
//		echo " UPDATE " . $tableName." SET ".$sqlval." WHERE ".$KeyStr."";
		return $res;
	}
