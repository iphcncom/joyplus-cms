...
//Copyright (C) 2009 - 2012 ... maccms.com  All Rights Reserved.
//郑重声明:
//    1、任何个人或组织不得以盈利为目的发布,修改,本软件及其他副本上一切关于版权的信息；
//    2、本人保留此软件的法律追究权利；
//==========================================================================================
document.write('<scr' + 'ipt src="' + maccms_path + 'js/playerconfig.js">'
		+ '</scr' + 'ipt>');
