...
<form method="post" action="?action=configsave" id="form1" name="form1">
	...
	<tr>
      <td>缓存时间：</td>
      <td>
      <input name="app_cachetime" type="text" id="app_cachetime" value="<?php echo app_cachetime?>" size="5">
      缓存标示：<input name="app_cacheid" type="text" id="app_cacheid" value="<?php echo app_cacheid?>" size="25">
        </td>
    </tr>
    <tr>
      <td>内存缓存设定：</td>
    ...
    <tr>
      ...
      <td>
        ...
        <option value="0" <?php if( app_playtype==0){echo "selected";}?>>有内容页播放</option>
        <option value="1" <?php if( app_playtype==1){echo "selected";}?>>无内容页播放</option>
        </select>
        &nbsp;播放浏览模式：
	...
	<tr>
      ...
      <td>
		<select name="app_vodsuffix" id="app_vodsuffix" style="width:150px">
		  ...
		  <option value="php" <?php if( app_vodsuffix=="php"){echo "selected";}?>>php</option>
    ...
    <tr>
      ...
      <td>
		<select name="app_artsuffix" id="app_artsuffix" style="width:150px">
		  ...
		  <option value="php" <?php if( app_artsuffix=="php"){echo "selected";}?>>php</option>
...
<font color="#FF0000">＊</font><select style="width:120px" onChange="sethtmldir('app_arttopicpath',this.value);"><option>常用结构</option><option value="arttopichtml/{id}/index">1.arttopichtml/id/</option><option value="arttopichtml/{md5}/index">2.arttopichtml/md5值/</option></option><option value="arttopichtml/{enname}/index">3.arttopichtml/enname/</option><option value="arttopichtml/{id}">4.arttopichtml/id.html</option><option value="arttopichtml/{md5}">5.arttopichtml/md5.html</option><option value="arttopichtml/{enname}">6.arttopichtml/enname.html</option></select> </td>
    ...
    <tr>
      <td>注册赠送点数：</td>
      <td><input name="app_regpoint" type="text" id="app_regpoint" value="<?php echo app_regpoint?>" size="10" >
        <font color="#FF0000">＊</font></td>
    </tr>
    <tr>
      <td>每推广1个人获取积分数：</td>
      <td>
        <input name="app_popularize" type="text" id="app_popularize" value="<?php echo app_popularize?>" size="10" /><font color="#FF0000">＊</font> </td>
    </tr>
     <tr align="center">
      <td colspan="2">
