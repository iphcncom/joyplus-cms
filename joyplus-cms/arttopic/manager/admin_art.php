...
<table class="tb">
	...
	<td><?php echo isToDay($row["a_time"])?></td>
	...
	<?php echo pagelist_manage($pagecount,$pagenum,$nums,app_pagenum,"admin_art.php?page={p}&keyword=" . urlencode($keyword) ."&order=".$order ."&stype=" . $stype ."&state=".$state."&repeat=".$repeat."&repeatlen=".$repeatlen."&hide=".$hide)?>
	</td>
    </tr>
</table>
</form>
...
<table class="tb">
	...
	<option style="background-color:<?php echo $a_color?>;color: <?php echo $a_color?>" value="<?php echo $a_color?>">选择颜色</option>
	...
	<td>文章作者：</td>
	<td>
	&nbsp;<input id="a_author" name="a_author" size="25" value="<?php echo $a_author?>" >
	&nbsp;文章来源：&nbsp;<input id="a_from" name="a_from" size="25" value="<?php echo $a_from?>" >
	</td>
	</tr>
	<tr> 
    <td>图片：</td>
    <td>&nbsp;<input id="pic" name="pic" type="text" size="50" value="<?php echo $a_pic?>">&nbsp;<iframe src="editor/uploadshow.php?action=art" scrolling="no" topmargin="0" width="320" height="24" marginwidth="0" marginheight="0" frameborder="0" align="center"></iframe></td>
	</tr>
	<tr>
	<td>其他：</td>
